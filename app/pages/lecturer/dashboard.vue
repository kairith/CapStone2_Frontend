                            ...
                            <div v-for="classItem in todayClasses" :key="classItem.id" class="schedule-item pa-4 mb-3"
                                ...
                                <div class="d-flex align-center justify-space-between">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <div>
                                            <v-btn v-if="classItem.status === 'ongoing'" color="primary" size="small"
                                                variant="flat">
                                                Take Attendance
                                            </v-btn>
                                            <v-btn v-else-if="classItem.status === 'upcoming'" color="primary"
                ...
                <v-card elevation="1" class="mb-4">
                    ...
                    <v-card-text class="pa-2">
                        <v-list density="compact" class="py-0">
                            <v-list-item to="/lecturer/classes" prepend-icon="mdi-google-classroom"
                                class="rounded-lg mb-1">
                                <v-list-item-title>View All Classes</v-list-item-title>
                            </v-list-item>
                            <v-list-item to="/lecturer/schedule" prepend-icon="mdi-calendar-clock"
                                class="rounded-lg mb-1">
