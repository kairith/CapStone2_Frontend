...
const filteredReports = computed(() => {
    ...
    if (search.value) {
        ...
        filtered = filtered.filter(report =>
            report.instructorName.toLowerCase().includes(query) ||
            report.subjectName.toLowerCase().includes(query) ||
            report.subjectCode.toLowerCase().includes(query) ||
            report.groupName.toLowerCase().includes(query) ||
            (report.departmentName && report.departmentName.toLowerCase().includes(query))
        )
    }
...
const filteredRows = computed(() => filteredReports.value)
